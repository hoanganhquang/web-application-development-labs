    ...
    <div class="container">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $student["MSSV"]; ?>" class="form-control" id="mssv" placeholder="MSSV" name="mssv">
            </div>
            <div class="form-group">
                <label for="pwd">Họ tên</label>
                <input type="text" value="<?php echo $student["HoTen"]; ?>" class="form-control" id="hoten" placeholder="Họ tên" name="hoten">
            </div>
            <div class="form-group">
...
select example'>";
            ...
            <div class="form-group">
                ...
                <input value="<?php echo $student["Tuoi"]; ?>" type="number" class="form-control" id="tuoi" name="tuoi">
            </div>
